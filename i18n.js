...
const TRANSLATIONS = {
  ...
  en: {
    ...
    "index.feat_views_body":      "Kanban, calendar, list, cards, and focus. Configure views per workspace, filter and combine. Each project looks exactly how you need it.",
    ...
    "index.feat_history_body":    "Every change is automatically saved in the cloud. Travel back to any previous version of your nodes with a click.",
    ...
    "index.sync_backup_body":  "Your data is stored securely on Cloudflare R2. Automatic backups of your entire tree. Restore any previous version with one click.",
